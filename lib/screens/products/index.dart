                                    ...
                                    children: [
                                      TableRow(
                                        children: [
                                          ...
                                          Text(
                                            product.productList[index].catId !=
                                                    '0'
                                            ...
                                            children: [
                                              TableRow(
                                                children: [
                                                  ...
                                                  Text(
                                                    '${AppLocalizations.of(context).translate('buy_price')!}',
                                                    style: tableHeaderSub,
                                                    textAlign: TextAlign.center,
                                                  ),
                                                  Text(
                                                    '${AppLocalizations.of(context).translate('sell_price')!}',
                                                    style: tableHeaderSub,
                                                    textAlign: TextAlign.center,
                                                  ),
                                                  Text(
                                                            ...
                                                            child: Table(
                                                              children: [
                                                                TableRow(
                                                                  children: [
                                                                    Text(
                                                                      unitsProduct.productSelectedUnitsList[unitsIndex].unitId! <
                                                                              unit.unitsList.length
