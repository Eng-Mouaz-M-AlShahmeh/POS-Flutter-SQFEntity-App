                                  ...
                                  child: Table(
                                    children: [
                                      TableRow(
                                        children: [
                                          Text(
                                            'الإجمالي قبل الخصم: ${buyInvoice.totalBeforeDiscount.toStringAsFixed(2)} ريال',
                                            style: tableHeader,
                                            textAlign: TextAlign.center,
                                          ),
                                        ],
                                          ...
                                          onChanged: (val) {
                                            ...
                                            buyInvoice.setDiscountPercentage(
                                                double.tryParse(
                                                    ...
                                                    .round());
                                            buyInvoice.setTotalAfterDiscount();
                                  ...
                                  child: Table(
                                    children: [
                                      TableRow(
                                        children: [
                                          Text(
                                            'الإجمالي بعد الخصم: ${buyInvoice.totalAfterDiscount.toStringAsFixed(2)} ريال',
                                            style: tableHeader,
                                            textAlign: TextAlign.center,
                                          ),
                                        ],
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'المبلغ بعد الضريبة: ${buyInvoice.totalAfterVAT.toStringAsFixed(2)} ريال',
                                        style: vatFinalText,
                                        textAlign: TextAlign.center,
                                      ),
                                    ],
                            ...
                            child: InkWell(
                              onTap: () async {
                                await buyInvoice.setQrImageFile(await qrImage(
                                    context,
                                    'Final Total: ${buyInvoice.totalAfterVAT}'));
                                ...
                                await buyInvoice.addInvoiceMain(
                                  ...
                                  BuyInvoice(
                                    ...
                                    totalBeforeDiscount:
                                        buyInvoice.totalBeforeDiscount.toString(),
                                    totalAfterDiscount:
                                        buyInvoice.totalAfterDiscount.toString(),
                                    totalAfterVAT: buyInvoice.totalAfterVAT.toString(),
                                    discountAmount:
                                        buyInvoice.discountFixedAmount.toString(),
